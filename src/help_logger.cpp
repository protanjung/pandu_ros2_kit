...
void
HelpLogger::debug(const char* fmt, ...) {
    va_list args;
    va_start(args, fmt);
...
void
HelpLogger::info(const char* fmt, ...) {
    va_list args;
    va_start(args, fmt);
...
void
HelpLogger::warn(const char* fmt, ...) {
    va_list args;
    va_start(args, fmt);
...
void
HelpLogger::error(const char* fmt, ...) {
    va_list args;
    va_start(args, fmt);
...
void
HelpLogger::fatal(const char* fmt, ...) {
    va_list args;
    va_start(args, fmt);
